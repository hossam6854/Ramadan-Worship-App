...
const ProgressBar = () => {
  ...
  const stats = useMemo(() => {
    ...
    const completed = Object.values(prayers).filter(prayer => prayer.completed).length;
  ...
  return (
    <div className="bg-white rounded-xl shadow-lg p-6 mt-8">
      <div className="flex items-center gap-3 mb-4">
        ...
        <h2 className="text-2xl font-bold text-gray-800">إحصائيات اليوم</h2>
      </div>
      ...
      {prayerHistory.length > 0 && (
        <div className="mt-6">
          <div className="flex items-center gap-2 mb-3">
            ...
            <h3 className="text-lg font-semibold text-gray-800">سجل الصلوات السابقة</h3>
          </div>
